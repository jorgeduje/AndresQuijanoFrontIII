...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        opacity: 1,
        backgroundColor: theme.palette.mode === "dark" ? "#f0ebdb" : "#9fc4e2",
      },
    },
  },
  "& .MuiSwitch-thumb": {
    backgroundColor: theme.palette.mode === "dark" ? "#581795" : "#581795",
    width: 22,
    height: 22,
    "&:before": {
      content: "''",
  ...
  "& .MuiSwitch-track": {
    opacity: 1,
    backgroundColor: theme.palette.mode === "dark" ? "#9fc4e2" : "#f0ebdb",
    borderRadius: 20 / 2,
  },
}));
  ...
  return (
    <div>
      <ul className={stylesNav.container}>
        ...
        <li>
          <Link className={stylesNav.links } to="/dashboard">Dentists</Link>
        </li>
        <li>
